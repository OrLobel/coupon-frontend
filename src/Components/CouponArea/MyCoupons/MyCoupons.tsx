...
import CustomerBoughtCouponCard from "../CustomerBoughtCouponCard/CustomerBoughtCouponCard";
...
function MyCoupons(): JSX.Element {
    ...
    useEffect(() => {
        web.getCustomerCoupons()
            .then((res) => {
                notify.success(SccMsg.ALL_MY_COUPONS);
    ...
    const catergoryClick = () => {
        ...
        web.getCustomerCouponsWithCategory(category)
            .then((res) => {
            ...
            <div className="flex-row-none-wrap-list">
                {
                    (coupons.length > 0)
                        ...
                        coupons.map(t => <CustomerBoughtCouponCard key={t.id} coupon={t} />)
                        :
